    ...
    posts_data = [
        {
            ...
            'pet_size': 'medium',
            'last_seen_location': 'Parque Ibirapuera, Portão 3, São Paulo/SP',
        ...
        },
        {
            ...
            'pet_size': 'small',
            'last_seen_location': 'Rua das Hortênsias, 45 — Jardim América, São Paulo/SP',
            'contact_phone': '(11) 98765-4321',
            'contact_email': 'maria@exemplo.com',
            'user_id': maria.id,
        },
        {
            ...
            'pet_color': 'Dourada',
            'pet_size': 'large',
            'last_seen_location': 'Praia de Copacabana, perto do posto 4, Rio de Janeiro/RJ',
        ...
        },
        {
            ...
            'pet_size': None,
            'last_seen_location': 'Rua Pernambuco, 800 — Savassi, Belo Horizonte/MG',
        ...
        },
        {
            ...
            'pet_size': 'small',
            'last_seen_location': 'Rua das Flores, próximo à Praça Osório, Curitiba/PR',
